...
// ADD CLASSNAMES SYNDIKAT
	...
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["I_C_Soldier_Para_7_F","I_C_Soldier_Para_2_F","I_C_Helipilot_F","I_C_Soldier_Para_3_F","I_C_Soldier_Para_4_F","I_C_Soldier_Para_6_F","I_C_Soldier_8_F","I_C_Soldier_Para_1_F","I_C_Soldier_Para_5_f"];
	_heliCrew=	[];
	};
