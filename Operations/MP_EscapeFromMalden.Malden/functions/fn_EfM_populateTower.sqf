...
_unit01a = _grp01 createUnit [selectRandom ["B_Soldier_F","B_Soldier_GL_F"], [0,0,0], [], 0, "CAN COLLIDE"];
_unit01a setPosASL _pos01a;
_unit01b = _grp01 createUnit [selectRandom ["B_HeavyGunner_F","B_Soldier_AR_F"], [0,0,0], [], 0, "CAN COLLIDE"];
...
_unit02a = _grp02 createUnit ["B_Medic_F", [0,0,0], [], 0, "CAN COLLIDE"];
_unit02a setPosASL _pos02a;
_unit02b = _grp02 createUnit ["B_Soldier_LAT_F", [0,0,0], [], 0, "CAN COLLIDE"];
...
_unit03a = _grp03 createUnit [selectRandom ["B_Soldier_F","B_Soldier_GL_F"], [0,0,0], [], 0, "CAN COLLIDE"];
_unit03a setPosASL _pos03a;
_unit03b = _grp03 createUnit [selectRandom ["B_Soldier_M_F","B_Sharpshooter_F"], [0,0,0], [], 0, "CAN COLLIDE"];
...
_unit04a = _grp04 createUnit [selectRandom ["B_Soldier_SL_F","B_Soldier_TL_F"], [0,0,0], [], 0, "CAN COLLIDE"];
_unit04a setPosASL _pos04a;
_unit04b = _grp04 createUnit ["B_Soldier_AA_F", [0,0,0], [], 0, "CAN COLLIDE"];
