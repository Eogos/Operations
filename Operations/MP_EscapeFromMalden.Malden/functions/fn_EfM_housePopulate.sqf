...
switch (typeOf _house) do {
	case "Land_Shop_City_07_F": {
		...
		_unit01a = _grp01 createUnit [selectRandom ["I_C_Soldier_Para_7_F","I_C_Soldier_Bandit_6_F"], _pos01a, [], _dir01, "CAN COLLIDE"];
		_unit01a setPosASL _pos01a;
		_unit01b = _grp01 createUnit [selectRandom ["I_C_Soldier_Para_4_F","I_C_Soldier_Bandit_4_F"], _pos01b, [], _dir01, "CAN COLLIDE"];
		...
		_unit02a = _grp02 createUnit [selectRandom ["I_C_Soldier_Para_6_F","I_C_Soldier_Bandit_7_F"], _pos02a, [], _dir02, "CAN COLLIDE"];
		_unit02a setPosASL _pos02a;
		_unit02b = _grp02 createUnit [selectRandom ["I_C_Soldier_Para_5_F","I_C_Soldier_Bandit_5_F"], _pos02b, [], _dir02, "CAN COLLIDE"];
