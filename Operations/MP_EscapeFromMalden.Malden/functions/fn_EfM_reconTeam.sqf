...
// Team leader
_unit01 = _newGrp createUnit ["B_recon_TL_F", [_axisX,_axisY,0], [], 0, "CAN COLLIDE"];
...
// Marksman
_unit02 = _newGrp createUnit ["B_recon_M_F", [_axisX + 1,_axisY,0], [], 0, "CAN COLLIDE"];
...
// Paramedic
_unit03 = _newGrp createUnit ["B_recon_medic_F", [_axisX + 2,_axisY,0], [], 0, "CAN COLLIDE"];
...
// Scout
_unit04 = _newGrp createUnit ["B_recon_F", [_axisX + 3,_axisY,0], [], 0, "CAN COLLIDE"];
