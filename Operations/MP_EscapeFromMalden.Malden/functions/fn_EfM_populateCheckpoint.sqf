...
_unit01 = _grp01 createUnit [selectRandom ["B_Soldier_F","B_Soldier_GL_F"], [0,0,0], [], 0, "CAN COLLIDE"];
_unit01 setPosASL _pos01;
_unit02 = _grp01 createUnit [selectRandom ["B_Soldier_AR_F","B_HeavyGunner_F"], [0,0,0], [], 0, "CAN COLLIDE"];
...
_unit03 = _grp02 createUnit [selectRandom ["B_Soldier_F","B_Soldier_GL_F"], [0,0,0], [], 0, "CAN COLLIDE"];
_unit03 setPosASL _pos03;
_unit04 = _grp02 createUnit [selectRandom ["B_Soldier_M_F","B_Sharpshooter_F"], [0,0,0], [], 0, "CAN COLLIDE"];
...
_unit05 = _grp03 createUnit [selectRandom ["B_Soldier_TL_F","B_Soldier_SL_F"], getMarkerPos _marker01, [], 0, "CAN COLLIDE"];
_unit06 = _grp03 createUnit [selectRandom ["B_Soldier_GL_F","B_Soldier_AR_F"], getMarkerPos _marker01, [], 0, "CAN COLLIDE"];
_unit07 = _grp03 createUnit [selectRandom ["B_Medic_F","B_Soldier_F"], getMarkerPos _marker01, [], 0, "CAN COLLIDE"];
_unit08 = _grp03 createUnit ["B_Soldier_LAT_F", getMarkerPos _marker01, [], 0, "CAN COLLIDE"];
