...
null = [["FOB1"],[3,2],[1,2],[0,0],[0],[0],[0,0],[5,0,1000,INDEPENDENT,FALSE,FALSE]] call EOS_Spawn;
...
null = [["City1"],[8,2],[3,2],[0,0],[0],[0],[0,0],[5,0,1000,INDEPENDENT,FALSE,FALSE]] call EOS_Spawn;