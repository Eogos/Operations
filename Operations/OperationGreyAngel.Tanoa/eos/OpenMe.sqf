...
null = [["Tzone1","Tzone2"],[6,2],[4,2],[0,0],[0],[0],[0,0],[5,0,750,INDEPENDENT,FALSE,FALSE]] call EOS_Spawn;
null = [["ABZone"],[6,3],[3,2],[0,0],[0],[0],[0,0],[5,0,750,INDEPENDENT,FALSE,FALSE]] call EOS_Spawn;
null = [["NPZone"],[3,1],[5,2],[3,1],[0],[0],[0,0],[5,0,750,INDEPENDENT,FALSE,FALSE]] call EOS_Spawn;
null = [["SPZone"],[2,1],[3,2],[0,0],[0],[0],[0,0],[5,0,750,INDEPENDENT,FALSE,FALSE]] call EOS_Spawn;
null = [["MythicDidIt"],[4,2],[3,1],[0,0],[0],[0],[0,0],[5,0,750,INDEPENDENT,FALSE,FALSE]] call EOS_Spawn;