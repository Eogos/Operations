...
// REDFOR (A3)
  case 0:
  {
      _Unit_Pool_S = ["O_T_crew_F","O_T_Helipilot_F","O_T_Soldier_SL_F","O_T_soldier_AR_F","O_T_soldier_AR_F","O_T_soldier_exp_F","O_T_soldier_GL_F","O_T_soldier_GL_F","O_T_soldier_M_F","O_T_medic_F","O_T_soldier_repair_F","O_T_Soldier_F","O_T_Soldier_F","O_T_soldier_LAT_F","O_T_soldier_LAT_F","O_T_soldier_lite_F","O_T_soldier_TL_F","O_T_soldier_TL_F"];
      _Unit_Pool_V = ["O_T_MRAP_02_ghex_F","O_T_MRAP_02_hmg_ghex_F","O_T_LSV_02_unarmed_ghex_F","O_T_LSV_02_armed_ghex_F"];
    ...
    _Unit_Pool_A = ["O_Heli_Light_02_v2_F","O_Heli_Light_02_unarmed_F","O_T_VTOL_02_infantry_ghex_F"];
  };
//-------------------------------------------------------------------------------------------------
// BLUFOR (A3)
  case 1:
...
// Independent (A3)
  case 2:
  {
      _Unit_Pool_S = ["I_C_Soldier_Bandit_1_F","I_C_Soldier_Bandit_2_F","I_C_Soldier_Bandit_3_F","I_C_Soldier_Bandit_4_F","I_C_Soldier_Bandit_5_F","I_C_Soldier_Bandit_6_F","I_C_Soldier_Bandit_7_F","I_C_Soldier_Bandit_8_F"];
      _Unit_Pool_V = ["I_C_Offroad_02_unarmed_brown_F","I_C_Offroad_02_unarmed_olive_F","I_C_Offroad_02_unarmed_F","I_C_Van_01_transport_F","I_C_Van_01_transport_brown_F","I_C_Van_01_transport_olive_F"];
