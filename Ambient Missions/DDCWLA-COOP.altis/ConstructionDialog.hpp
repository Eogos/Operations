...
class ConstructionDialog {
    ...
    objects[] = {};
	onLoad = "";
	onUnload = "if (!isNil{SaOkmissionnamespace getvariable ""CurObject""} && {isNil{SaOkmissionnamespace getvariable ""ConsMoved""}}) then {deletevehicle (SaOkmissionnamespace getvariable ""CurObject"");SaOkmissionnamespace setvariable [""CurObject"",nil];};";
...
{
	idc = 1605;
	text = "Draw"; //--- ToDo: Localize;
	x = 1.5 * GUI_GRID_W + GUI_GRID_X;
	y = 17.5 * GUI_GRID_H + GUI_GRID_Y;
	w = 4.5 * GUI_GRID_W;
	h = 1.5 * GUI_GRID_H;
	action = "_n = [] SPAWN FDRAW;";	
};
*/
...
class RscButton_1600: RscButton
{
	...
	w = 3 * GUI_GRID_W;
	h = 2 * GUI_GRID_H;
	action = "if (isNil""BUYING"") then {[] CALL SAOKCONSBUY;closedialog 0;[] CALL SAOKDIARESET;};";
};
