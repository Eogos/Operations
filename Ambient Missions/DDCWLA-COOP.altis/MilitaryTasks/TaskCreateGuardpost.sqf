...
_nul = [_head, _toChoose,"S",[["V17","JinN15"],["V18","JinN9","JinN10","JinN12"],["V13","V16","V40"]],(player getvariable "CivC")] SPAWN FConversationDialogSol;
//TASK TAKEN
waitUntil {sleep 0.5; scriptdone _nul};
if (isNil"LineSelected") exitWith {};
if (LineSelected == 0) then {
[[],"TASK_CreateGuardpost",false,false] spawn BIS_fnc_MP;
} else {
//ANOTHER TASK
