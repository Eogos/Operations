...
class RscButton_1600: RscButton
{
	...
	w = 2.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	action = "SaOkmissionnamespace setvariable [""AddIndex1520"",lbCurSel 1520];[lbCurSel 1520,lbCurSel 1521] CALL SAOKADDONVEH2ADD;closeDialog 0;[] SPAWN SAOKADDONVEH2DIA;";
};
class RscButton_1601: RscButton
{
	...
	w = 5.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	action = "SaOkmissionnamespace setvariable [""AddIndex1520"",lbCurSel 1520];[lbCurSel 1521] CALL SAOKADDONVEH2REMLAST;closeDialog 0;[] SPAWN SAOKADDONVEH2DIA;";
};
