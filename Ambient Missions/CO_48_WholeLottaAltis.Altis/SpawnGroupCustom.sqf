...
{
if (isNil"NORANWEES" && {side _x in [WEST,EAST]}) then {_x SPAWN {sleep 2;_nul = [_this, 1] CALL FUNKTIO_NATORUS;};};
if (paramsArray select 11 == 1) then {_x addEventHandler ["killed",{[_this select 0,_this select 1] SPAWN oPKDW3;}];};
