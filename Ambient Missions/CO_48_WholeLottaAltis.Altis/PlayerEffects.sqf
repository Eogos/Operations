private ["_c","_v1","_v2","_v3","_func","_hndl","_hndl2"];
_func = {
private ["_rmusic","_w"];
_this setvariable ["SaOkHealed",1];
...
_this setvariable ["SaOkHealed",nil];
_this allowdamage true;
};
waitUntil {sleep 1; !isNil"StartMission"};
if (isNil"PNEEDS") exitWith {};
...
_v2 = _c * 0.1;
_v3 = _c * 0.233;
if (_c > 2 && {random 1 < 0.015} && {vehicle player == player} && {isNil{player getvariable "SaOkHealed"}}) then {
...
TVasynyt = nil;
_ran = 10 + (random 30);
_nul = [_x,"SUCCEEDED"] call BIS_fnc_taskSetState;
