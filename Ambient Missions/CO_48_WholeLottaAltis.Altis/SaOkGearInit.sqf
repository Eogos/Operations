...
{
if (_w == _x select 0) exitWith {
SaOkGearAttachments = [SaOkGearAttachments,_forEachIndex] call BIS_fnc_removeIndex;
};
...
//{if (_x == _w) exitWith {SaOkGearAttachments = [SaOkGearAttachments,_forEachIndex] call BIS_fnc_removeIndex;};} foreach SaOkGearAttachments;
};
...
{
if (_w == _x select 0) exitWith {
SaOkGearPrimW = [SaOkGearPrimW,_forEachIndex] call BIS_fnc_removeIndex;
};
...
{
if (_w == _x select 0) exitWith {
SaOkGearSecW = [SaOkGearSecW,_forEachIndex] call BIS_fnc_removeIndex;
};
...
{
if (_w == _x select 0) exitWith {
SaOkGearPistol = [SaOkGearPistol,_forEachIndex] call BIS_fnc_removeIndex;
};
...
SaOkGearOther = [SaOkGearOther,_forEachIndex] call BIS_fnc_removeIndex;
};
...
{
if (_item == _x select 0) exitWith {
SaOkGearFatigue= [SaOkGearFatigue,_forEachIndex] call BIS_fnc_removeIndex;
};
} foreach SaOkGearFatigue;
};
case "B": {
{
if (_item == _x select 0) exitWith {
SaOkGearBackPack= [SaOkGearBackPack,_forEachIndex] call BIS_fnc_removeIndex;
};
} foreach SaOkGearBackPack;
};
case "V": {
{
if (_item == _x select 0) exitWith {
SaOkGearVest= [SaOkGearVest,_forEachIndex] call BIS_fnc_removeIndex;
};
} foreach SaOkGearVest;
};
};
