...
_group = [[(_pP select 0)+10-(random 20),(_pP select 1)+10-(random 20),0], WEST, [_uClass],[],[],[0.9,1.0]] call SpawnGroupCustom;
_unit = leader _group;
