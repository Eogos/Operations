...
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKls = SAOKls - [_x];}; 
} foreach SAOKls;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKrs = SAOKrs - [_x];}; 
} foreach SAOKrs;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKps = SAOKps - [_x];}; 
} foreach SAOKps;
[] SPAWN {
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKunif = SAOKunif - [_x];}; 
sleep 0.01;
} foreach SAOKunif;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKvest = SAOKvest - [_x];}; 
sleep 0.01;
} foreach SAOKvest;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKpack = SAOKpack - [_x];}; 
sleep 0.01;
} foreach SAOKpack;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKitem = SAOKitem - [_x];}; 
sleep 0.01;
} foreach SAOKitem;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKmag = SAOKmag - [_x];}; 
sleep 0.01;
} foreach SAOKmag;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKhat = SAOKhat - [_x];}; 
sleep 0.01;
} foreach SAOKhat;
{
if !(["LIB", _x] call BIS_fnc_inString) then  {SAOKglas = SAOKglas - [_x];}; 
sleep 0.01;
} foreach SAOKglas;
};
};
/*
Publicvariable "FRIENDC5";
Publicvariable "SAOKls";
Publicvariable "SAOKrs";
Publicvariable "SAOKps";
Publicvariable "SAOKunif";
Publicvariable "SAOKvest";
Publicvariable "SAOKpack";
Publicvariable "SAOKitem";
Publicvariable "SAOKmag";
Publicvariable "SAOKhat";
Publicvariable "SAOKglas";
*/
