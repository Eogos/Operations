...
_oldVehAr = _mN call SAOKZONEDR;
_newAr = [];
{_newAr pushback (_vehAr call RETURNRANDOM);} foreach _oldVehAr;
//SaOkmissionnamespace setvariable [_mN,_newAr];
{if (_mN == _x select 0) exitWith {_ar = _x select 1; ZONEDATA set [_foreachIndex, [_mN,_newAr]];};} foreach ZONEDATA; 
...
SaOkmissionnamespace setvariable ["helpD",_helpD];
_n = 0;
if (!isNil{SaOkmissionnamespace getvariable "AddIndex1520"}) then {_n = SaOkmissionnamespace getvariable "AddIndex1520";};
lbSetCurSel [1520, _n];
...
_n = 0;
if (!isNil{SaOkmissionnamespace getvariable "AddIndex1521"}) then {_n = SaOkmissionnamespace getvariable "AddIndex1521";};
lbSetCurSel [1521, _n];
_in = 0;
...
SaOkmissionnamespace setvariable ["AddIndex1521",_side];
switch _side do {
case 0: {_old = (ARMEDSUPPORT select 0); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDSUPPORT set [0,_new];publicvariable "ARMEDSUPPORT";};
case 1: {_old = (ARMEDSUPPORT select 1); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDSUPPORT set [1,_new];publicvariable "ARMEDSUPPORT";};
case 2: {_old = (ARMEDSUPPORT select 2); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDSUPPORT set [2,_new];publicvariable "ARMEDSUPPORT";};
case 3: {CIVVEH = [CIVVEH,(count CIVVEH - 1)] call BIS_fnc_removeIndex;publicvariable "CIVVEH";};
};
};
...
//{if (_classN == _x select 1) exitWith {_item = _x select 0};} foreach (SaOkmissionnamespace getvariable "helpD");
if (_item == "") exitWith {};
switch _side do {
case 0: {_old = (ARMEDSUPPORT select 0);_old set [count _old,_item];ARMEDSUPPORT set [0,_old];publicvariable "ARMEDSUPPORT";};
case 1: {_old = (ARMEDSUPPORT select 1);_old set [count _old,_item];ARMEDSUPPORT set [1,_old];publicvariable "ARMEDSUPPORT";};
case 2: {_old = (ARMEDSUPPORT select 2);_old set [count _old,_item];ARMEDSUPPORT set [2,_old];publicvariable "ARMEDSUPPORT";};
case 3: {CIVVEH set [count CIVVEH,_item];publicvariable "CIVVEH";};
};
};
...
SaOkmissionnamespace setvariable ["AddIndex1521",_side];
switch _side do {
case 0: {FRIENDC1 = [FRIENDC1,(count FRIENDC1 - 1)] call BIS_fnc_removeIndex;publicvariable "FRIENDC1";};
case 1: {FRIENDC2 = [FRIENDC2,(count FRIENDC2 - 1)] call BIS_fnc_removeIndex;publicvariable "FRIENDC2";};
case 2: {FRIENDC3 = [FRIENDC3,(count FRIENDC3 - 1)] call BIS_fnc_removeIndex;publicvariable "FRIENDC3";};
case 3: {FRIENDC4 = [FRIENDC4,(count FRIENDC4 - 1)] call BIS_fnc_removeIndex;publicvariable "FRIENDC4";};
case 4: {ENEMYC1 = [ENEMYC1,(count ENEMYC1 - 1)] call BIS_fnc_removeIndex;publicvariable "ENEMYC1";};
case 5: {ENEMYC2 = [ENEMYC2,(count ENEMYC2 - 1)] call BIS_fnc_removeIndex;publicvariable "ENEMYC2";};
case 6: {ENEMYC3 = [ENEMYC3,(count ENEMYC3 - 1)] call BIS_fnc_removeIndex;publicvariable "ENEMYC3";};
case 7: {CIVS1 = [CIVS1,(count CIVS1 - 1)] call BIS_fnc_removeIndex;publicvariable "CIVS1";};
};
};
...
if (_item == "") exitWith {};
switch _side do {
case 0: {FRIENDC1 set [count FRIENDC1,_item];publicvariable "FRIENDC1";};
case 1: {FRIENDC2 set [count FRIENDC2,_item];publicvariable "FRIENDC2";};
case 2: {FRIENDC3 set [count FRIENDC3,_item];publicvariable "FRIENDC3";};
case 3: {FRIENDC4 set [count FRIENDC4,_item];publicvariable "FRIENDC4";};
case 4: {ENEMYC1 set [count ENEMYC1,_item];publicvariable "ENEMYC1";};
case 5: {ENEMYC2 set [count ENEMYC2,_item];publicvariable "ENEMYC2";};
case 6: {ENEMYC3 set [count ENEMYC3,_item];publicvariable "ENEMYC3";};
case 7: {CIVS1 set [count CIVS1,_item];publicvariable "CIVS1";};
};
};
...
_n = 0;
if (!isNil{SaOkmissionnamespace getvariable "AddIndex1522"}) then {_n = SaOkmissionnamespace getvariable "AddIndex1522";};
lbSetCurSel [1522, _n];
...
SaOkmissionnamespace setvariable ["AddIndex1522",_section];
switch _section do {
case 0: {_old = + (AIRFIGTHER select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; AIRFIGTHER set [_side,_new];publicvariable "AIRFIGTHER";};
case 1: {_old = + (AIRARMCHOP select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; AIRARMCHOP set [_side,_new];publicvariable "AIRARMCHOP";};
case 2: {_old = + (AIRCARRIERCHOP select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; AIRCARRIERCHOP set [_side,_new];publicvariable "AIRCARRIERCHOP";};
};
...
if (_item == "") exitWith {};
switch _section do {
case 0: {_old = +(AIRFIGTHER select _side); _new = _old + [_item]; AIRFIGTHER set [_side,_new];publicvariable "AIRFIGTHER";};
case 1: {_old = +(AIRARMCHOP select _side); _new = _old + [_item]; AIRARMCHOP set [_side,_new];publicvariable "AIRARMCHOP";};
case 2: {_old = +(AIRCARRIERCHOP select _side); _new = _old + [_item]; AIRCARRIERCHOP set [_side,_new];publicvariable "AIRCARRIERCHOP";};
};
};
...
SaOkmissionnamespace setvariable ["AddIndex1522",_section];
switch _section do {
case 0: {_old = + (ARMEDVEHICLES select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDVEHICLES set [_side,_new];publicvariable "ARMEDVEHICLES";};
case 1: {_old = + (ARMEDTANKS select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDTANKS set [_side,_new];publicvariable "ARMEDTANKS";};
case 2: {_old = + (ARMEDAA select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDAA set [_side,_new];publicvariable "ARMEDAA";};
case 3: {_old = + (ARMEDCARRIER select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDCARRIER set [_side,_new];publicvariable "ARMEDCARRIER";};
case 4: {_old = + (ARMEDSTATIC select _side); _new = [_old,(count _old - 1)] call BIS_fnc_removeIndex; ARMEDSTATIC set [_side,_new];publicvariable "ARMEDSTATIC";};
};
...
if (_item == "") exitWith {};
switch _section do {
case 0: {_old = +(ARMEDVEHICLES select _side); _new = _old + [_item]; ARMEDVEHICLES set [_side,_new];publicvariable "ARMEDVEHICLES";};
case 1: {_old = +(ARMEDTANKS select _side); _new = _old + [_item]; ARMEDTANKS set [_side,_new];publicvariable "ARMEDTANKS";};
case 2: {_old = +(ARMEDAA select _side); _new = _old + [_item]; ARMEDAA set [_side,_new];publicvariable "ARMEDAA";};
case 3: {_old = +(ARMEDCARRIER select _side); _new = _old + [_item]; ARMEDCARRIER set [_side,_new];publicvariable "ARMEDCARRIER";};
case 4: {_old = +(ARMEDSTATIC select _side); _new = _old + [_item]; ARMEDSTATIC set [_side,_new];publicvariable "ARMEDSTATIC";};
};
};