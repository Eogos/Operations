...
(_this select 0) forceadduniform (["U_NikosBody","U_Rangemaster","U_IG_leader","U_IG_Guerilla3_2","U_IG_Guerilla3_1","U_IG_Guerilla2_3","U_IG_Guerilla2_2","U_IG_Guerilla1_1","U_C_Poor_1","U_C_Poloshirt_tricolour","U_C_Poloshirt_stripped","U_C_Poloshirt_salmon","U_C_Poloshirt_redwhite","U_C_Poloshirt_burgundy","U_C_Poloshirt_blue","U_C_HunterBody_grn","U_C_Poloshirt_redwhite","U_C_Poloshirt_salmon","U_C_Poloshirt_tricolour","U_C_Poloshirt_redwhite","U_C_Poloshirt_stripped"] call RETURNRANDOM);
...
while {_maR == "30Rnd_65x39_case_mag" || {!isClass(configFile >> "cfgMagazines" >> _maR)} || {(getNumber (configfile >> "CfgMagazines" >> _maR >> "scope")) == 0}} do {
_weR = SAOKps call RETURNRANDOM;
_maR = (getArray (configfile >> "CfgWeapons" >> _weR >> "magazines")) call RETURNRANDOM;

};
{(_this select 0) addmagazine _maR;} foreach [0,1,2,3,4];
