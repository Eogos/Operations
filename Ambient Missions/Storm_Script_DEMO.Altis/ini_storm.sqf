...
null = [direction_duststorm, duration_duststorm, effect_on_objects, wall_of_dust] execvm "AL_storm\al_duststorm.sqf";
...
null = ["marker_start","marker_end"] execvm "AL_storm\al_tornado.sqf";
...
// MONSOON
null = [60,120,true] execvm "AL_storm\al_monsoon.sqf";

// DUST STORM
null = [80,180,true,true] execvm "AL_storm\al_duststorm.sqf";
