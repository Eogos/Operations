...
while {count _units > 4} do {sleep 7; {if (_x distance player > 420) then {_units = _units - [_x];deletevehicle _x;};} foreach _units;};
...
//Pgroups set [count Pgroups,_group]; "O_SDV_01_F"
