...
_nul = [_head, _toChoose,"S",[["V17","JinN13","JinN51","JinN52"],["V18","JinN9","JinN10","JinN11","JinN12","JinN14"],["V40"]],(player getvariable "CivC")] SPAWN FConversationDialogSol;
//TASK TAKEN
waitUntil {sleep 0.5; scriptdone _nul};
if (isNil"LineSelected") exitWith {};
if (LineSelected == 0) then {
[[],"TASK_ClearZone",false,false] spawn BIS_fnc_MP;
} else {
//ANOTHER TASK
